...
class Game:
    ...
    def restart_game(self):
        ...
        self.update_rap(self.settings['rap'])
        self.update_monster_speed(self.settings['monster_speed'])
        self.update_zoom(self.settings['zoom'])
        self.update_perspective(self.settings['perspective'])
        self.update_monster_ai(self.settings['monster_ai'])
        self.update_monster_vision(self.settings['monster_vision'])
        self.update_stun_time(self.settings['stun_time'])
        # Vuelve al estado de juego (Comentado para que no cierre el menú de ajustes al cambiar sprite)
        # self.state = 'running'
        self.end_sound_played = False
